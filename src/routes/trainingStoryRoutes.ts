...
router.post("/full", requireAuth, TrainingStoryController.createFull);
...
router.get("/:id/full", requireAuth, TrainingStoryController.getFullById);
router.put("/:id/full", requireAuth, TrainingStoryController.updateFull);
